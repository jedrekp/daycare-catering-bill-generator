...
class AttendanceServiceTest {
    ...
    @Test
    void shouldUpdateChildAttendanceInExistingAttendanceSheetObjectsWhenAttendanceSheetObjectsAlreadyExistForGivenDates() {
        //given
        Child testChild = new Child("Son", "Gohan", "songoku@fake.fake", false);
        ReflectionTestUtils.setField(testChild, "id", 1L);
    ...
    @Test
    void shouldReturnTheListOfUpdatedAttendanceSheetObjectsSortedByDateInAscendingOrder() {
        //given
        Child testChild = new Child("Son", "Gohan", "songoku@fake.fake", false);
        ReflectionTestUtils.setField(testChild, "id", 1L);
    ...
    @Test
    void shouldNotModifyAttenanceOfAnyOtherChildrenOnExistingAttendanceSheetObjects() {
        //given
        Child testChild = new Child("Son", "Gohan", "songoku@fake.fake", false);
        ReflectionTestUtils.setField(testChild, "id", 1L);
    ...
    @Test
    void shouldTrackChildsAttendanceByCreatingNewAttendanceSheetObjectsWhenAttendanceSheetObjectsNotExistForGivenDatesYet() {
        //given
        Child testChild = new Child("Son", "Gohan", "songoku@fake.fake", false);
        ReflectionTestUtils.setField(testChild, "id", 1L);
    ...
    @Test
    void shouldThrowExceptionWhenChildMarkedBothPresentAndAbsentForSameDateInUpdateRequest() {
        //given
        LocalDate testDate1 = LocalDate.of(2020, 3, 17); //Tuesday
        LocalDate testDate2 = LocalDate.of(2020, 3, 18); //Wednesday
    ...
    @Test
    void shouldThrowExceptionWhenSomeDatesInUpdateRequestNotWithinTheSelectedMonth() {
        //given
    ...
    @Test
    void shouldThrowExceptionWhenSomeDatesInUpdateRequestAreNotWeekdays() {
        LocalDate testDate1 = LocalDate.of(2020, 3, 17); //Tuesday
    ...
    @Test
    void shouldThrowExceptionWhenChildNotExistsOrArchived() {
        LocalDate testDate1 = LocalDate.of(2020, 3, 17); //Tuesday
